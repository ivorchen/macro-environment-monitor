...
export const INDICATOR_SOURCE_REGISTRY: readonly IndicatorSourceDefinition[] = [
  ...
  fred({ id: "growth-industrial-production-yoy", pillarId: "growth", indicator: "Industrial production YoY (growth proxy)", seriesId: "INDPRO", frequency: "monthly", unit: "Percent YoY", format: "percent", calculation: "year-over-year-percent", transformation: "Industrial production versus the same month last year; not total GDP", staleAfterDays: 75, featured: true }),
  fred({ id: "earnings-reported-profits-yoy", pillarId: "earnings", indicator: "Reported corporate profits YoY (earnings proxy)", seriesId: "CP", frequency: "quarterly", unit: "Percent YoY", format: "percent", calculation: "year-over-year-percent", transformation: "BEA economy-wide after-tax profits versus the same quarter last year; not forward index EPS", staleAfterDays: 200, featured: true }),
  fred({ id: "positioning-vix", pillarId: "positioning", indicator: "VIX (risk-sentiment proxy)", seriesId: "VIXCLS", frequency: "daily", unit: "Index", format: "index", transformation: "Cboe VIX daily close via FRED; expected volatility, not investor holdings", staleAfterDays: 5, featured: true }),
];
