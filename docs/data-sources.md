...
- Senate filings are delayed disclosures, not live trades. Party, ownership, amount range, trade date, disclosure date, lag, source, and freshness remain separate, and the module never changes the macro score.
